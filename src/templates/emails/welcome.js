...
export const welcomeEmail = ({ firstName, loginUrl }) => ({
  subject: 'Welcome to LMSPrime',
  html: `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <h2 style="color: #4f46e5;">Welcome to LMSPrime!</h2>
      <p>Hi ${firstName},</p>
      <p>Your account has been verified and is now active. You can log in using the button below:</p>
      <div style="text-align: center; margin: 30px 0;">
        <a href="${loginUrl}" style="background-color: #4f46e5; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: bold;">Log In</a>
      </div>
      <p>Thank you for joining LMSPrime.</p>
      <hr style="border: none; border-top: 1px solid #eee; margin: 30px 0;" />
      <p style="color: #999; font-size: 12px;">LMSPrime Platform</p>
    </div>
  `,
  text: `Hi ${firstName},\n\nYour account has been verified and is now active.\n\nLog in: ${loginUrl}\n\nThank you for joining LMSPrime.`,
});
