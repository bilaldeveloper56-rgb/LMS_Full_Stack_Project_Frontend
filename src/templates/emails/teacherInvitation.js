...
export const teacherInvitationEmail = ({
  ...
  subject: `You have been invited as a Faculty Teacher for ${schoolName} — LMSPrime`,
  html: `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1f2937; padding: 24px; border: 1px solid #e5e7eb; border-radius: 8px; background-color: #ffffff;">
      <div style="text-align: center; margin-bottom: 24px; border-bottom: 1px solid #e5e7eb; padding-bottom: 16px;">
        <h1 style="color: #4f46e5; margin: 0; font-size: 26px; font-weight: 800; letter-spacing: -0.5px;">LMSPrime</h1>
      ...
      <p style="font-size: 15px; line-height: 1.5; color: #374151;">You have been enrolled as a <strong>Faculty Teacher</strong> on the LMSPrime portal for <strong>${schoolName}</strong>.</p>
      ...
      <p style="color: #9ca3af; font-size: 12px; text-align: center; margin: 0;">LMSPrime SaaS Platform</p>
    </div>
  `,
